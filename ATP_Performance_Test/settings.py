...
SECRET_KEY = 'rtt2*a!)9jmju=ub!m(s7czus%%6c==rampsq)e)!@br)i$z$*'
...
INSTALLED_APPS = (
    ...
    'ATP_Performance_Test.misc',
    'ATP_Performance_Test.profiles',
    'ATP_Performance_Test.tuitter',
)
...
import os
os.environ["DATABASE_URL"] = "postgres://atp_performance_test:atp_performance_test@ec2-184-73-142-75.compute-1.amazonaws.com/atp_performance_test" 
